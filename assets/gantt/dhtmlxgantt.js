 ...
 * @license
 *
 * dhtmlxGantt v.5.1.0 dhtmlx.com
...
!function (t) {
    ...
    function i(t) {
        ...
        if (t.getBoundingClientRect) {
            var a = t.getBoundingClientRect(), s = document.body,
                ...
                d = window.pageXOffset || o.scrollLeft || s.scrollLeft, c = o.clientTop || s.clientTop || 0,
    ...
    function k(t, e, i) {
        ...
        for (var n = p(t), r = ""; n;) {
            if (r = d(n)) {
                ...
                if (a >= 0) {
                    if (!i)return n;
                    var s = 0 === a || !m(r.charAt(a - 1)), o = a + e.length >= r.length || !m(r.charAt(a + e.length));
                    if (s && o)return n
                }
            }
            n = n.parentNode
    ...
    function y(t, e) {
        ...
        var r = document.documentElement,
            n = {x: t.clientX + r.scrollLeft - r.clientLeft, y: t.clientY + r.scrollTop - r.clientTop}, a = i(e);
    ...
    var n = i(0), r = (i(11), i(2)), a = i(1), s = function () {
        "use strict";
        function t(t, e, i, s) {
        ...
        return t.prototype.destructor = function () {
            ...
            var i = this.$config, n = "";
            if (i.raw) t = "string" == typeof i.raw ? i.raw : ""; else if (t || (t = "<div class='gantt_layout_content' " + (e ? " class='" + e + "' " : "") + " >" + (i.html || "") + "</div>"), i.header) {
    ...
    var n = i(1), r = i(0), a = i(2), s = i(50), o = function (t, e, i, n) {
    ...
    o.prototype = {
        init: function (t) {
            ...
            var t = this, e = this.$config.rowStore;
            ...
            for (var s = e + 1; s < n.length; s++) {
                var c = n[s], h = Math.round(l * (c.width / r));
            ...
            if (t.autofit || n.length) {
                var l = o - i;
                if (t.autofit)for (var a = 0; a < r.length; a++) {
                    var d = Math.round(l / (r.length - a));
                    r[a] += d;
                    var c = this._getColumnWidth(e[a], t, r[a]);
                    c != r[a] && (d = c - r[a], r[a] = c), l -= d
                } else if (n.length)for (var a = 0; a < n.length; a++) {
                    var d = Math.round(l / (n.length - a)), h = n[a];
                    r[h] += d;
            ...
            for (var a = [], s = 0, o = i.labels, l = e.scale_height - 1, d = 0; d < r.length; d++) {
                var c = d == r.length - 1, h = r[d];
                h.name || (h.name = t.uid() + "");
                var u = 1 * h.width, _ = this._getGridWidth();
                ...
                var g = t._sort && h.name == t._sort.name ? "<div class='gantt_sort gantt_" + t._sort.direction + "'></div>" : "",
                    ...
                    p = "width:" + (u - (c ? 1 : 0)) + "px;", v = h.label || o["column_" + h.name];
                v = v || "";
    ...
    var n = i(3), r = i(1), a = (i(0), i(5)), s = function (t) {
        "use strict";
        function e(e, i, n) {
        ...
        return n(e, t), e.prototype.destructor = function () {
            ...
            if (t.length)for (var i = t[0].$parent._xLayout ? "width" : "height", n = t[0].$parent.getNextSibling(t[0].$id) ? 1 : -1, r = 0; r < t.length; r++) {
                ...
                var o = s.getSize();
                if (s[i]) {
                    var l = a.gravity + o.gravity, d = a[i] + o[i], c = l / d;
            ...
            for (var n = 0; n < e.length; n++)if (!e[n].$config.hidden) {
                var r = n >= i, a = "";
            ...
            for (var s = 0; s < this._sizes.length; s++)if (r = this.$cells[s], !r.$config.hidden) {
                var o = this.$config.margin || 0;
                "resizer" != r.$name || o || (o = -1);
                var l = r.$view, d = this._xLayout ? "marginRight" : "marginBottom";
            ...
            for (var s = 0; s < this._sizes.length; s++)if (r = this.$cells[s], !r.$config.hidden) {
                a = this._sizes[s];
                var c = a.width, h = a.height;
                this._xLayout ? this._calcFreeSpace(c, a, !0) : this._calcFreeSpace(h, a, !1)
            }
            for (var s = 0; s < this.$cells.length; s++)if (r = this.$cells[s], !r.$config.hidden) {
                a = this._sizes[s];
                var u = void 0, _ = void 0;
    ...
    function n(t, e) {
        for (var i, n, r, a = 0, s = t.length - 1; a <= s;)if (i = Math.floor((a + s) / 2), n = +t[i], r = +t[i - 1], n < e) a = i + 1; else {
            if (!(n > e)) {
                for (; +t[i] == +t[i + 1];)i++;
                return i
            }
    ...
    var r = i(14), a = i(2), s = i(0), o = i(49), l = function (t, e, i, n) {
    ...
    l.prototype = {
        init: function (t) {
            ...
            for (var n = this.$gantt.$services.templates(), r = [], a = n.scale_row_class, s = 0; s < t.length; s++) {
                var o = "gantt_scale_line", l = a(t[s]);
            ...
            var r = this.$getConfig(), a = this.$gantt.$services.templates(), s = [], o = null, l = null, d = null;
            (t.template || t.date) && (l = t.template || this.$gantt.date.date_to_str(t.date));
            var c = 0, h = t.count;
            !r.smart_scales || isNaN(e) || isNaN(i) || (c = n(t.left, e), h = n(t.left, i) + 1), d = t.css || function () {
                }, !t.css && r.inherit_scale_class && (d = a.scale_cell_class);
            for (var u = c; u < h && t.trace_x[u]; u++) {
                o = new Date(t.trace_x[u]);
                var _ = l.call(this, o), g = t.width[u], f = t.height, p = t.left[u], v = "", m = "", k = "";
                if (g) {
            ...
            var i = n(this._tasks.left, t), r = this._tasks.left[i], a = e.width[i] || e.col_width, s = 0;
            ...
            var e = new Date(t).valueOf(), i = this._tasks.trace_x_ascending, r = this._tasks.ignore_x,
            ...
            var l = this._tasks.trace_index_transition, d = s;
            if (!o)return l ? l[0] : 0;
    ...
    var n = i(17), r = i(0), a = i(2), s = function (t) {
    ...
    var n = i(17), r = i(0), a = i(2), s = i(16), o = function (t) {
    ...
    o.prototype = r.mixin({
        _buildTree: function (t) {
            ...
            var n = this.getIndexById(i), a = n + Math.min(Math.max(e, 0), this.visibleOrder.length);
            ...
            if (t != i) {
                i = i || this.$getRootId();
                var r = this.getItem(t), a = this.getParent(r.id),
    ...
    function s(t) {
        ...
        if (t.config.scale_offset_minimal) {
            var n = new d(t), r = [n.primaryScale()].concat(t.config.subscales);
    ...
    function o(t) {
        var e = s(t), i = e.unit, o = e.step, l = a(i, t);
    ...
    function n() {
        this.version = "5.1.0", this.templates = {}, this.keys = {edit_save: 13, edit_cancel: 27}
    }
        ...
        return {
            cache: !0, method: "get", parse: function (t) {
                ...
                if (a && (d.onreadystatechange = function () {
                    ...
                    }), "GET" != e || this.cache || (i += (i.indexOf("?") >= 0 ? "&" : "?") + "dhxr" + (new Date).getTime() + "=1"), d.open(e, i, a), l)for (var h in l)d.setRequestHeader(h, l[h]); else"POST" == e.toUpperCase() || "PUT" == e || "DELETE" == e ? d.setRequestHeader("Content-Type", "application/x-www-form-urlencoded") : "GET" == e && (r = null);
    ...
    t.exports = function (t) {
        var e = {
            init: function () {
                ...
                var n = i.getFullYear(), r = Math.round((i.getTime() - new Date(n, 0, 1).getTime()) / 864e5);
    ...
    t.exports = function (t) {
        ...
        function r(t) {
            if (p) {
                t = t || event;
                var i = t.which || event.keyCode, n = !1;
                if (b.keyboard) {
                    if (13 == i || 32 == i) {
        ...
        function d(i, r, a) {
            var o = document.createElement("DIV"), d = (t.locale, n.uid());
    ...
    var r = i(38), a = i(40), s = i(41), o = i(5), l = i(12), d = i(44), c = i(45), h = i(46), u = i(47), _ = i(13),
        g = i(8), f = i(51), p = i(52), v = i(53), m = i(54), k = i(55), y = i(56), b = i(57), $ = i(59), w = i(62);
    t.exports = {init: n}
}, function (t, e, i) {
    var n = i(0), r = i(39), a = function (t) {
        function e(t, e) {
            var n = "cell";
    ...
    var n = i(1), r = function (t) {
        return function (e) {
            ...
            function r(t) {
                t = t || window.event;
                var i = (t.target || t.srcElement, e.locate(t)), n = s(t, u.click), r = !0;
            ...
            function a(t) {
                t = t || window.event;
                var i = t.target || t.srcElement, n = e.locate(i), r = e.locate(i, e.config.link_attribute),
            ...
            function l(t) {
                t = t || window.event;
                var i = (t.target || t.srcElement, e.locate(t)), n = s(t, u.doubleclick),
            ...
            var u = {click: {}, doubleclick: {}, contextMenu: {}}, _ = e._createDomEventScope();
            return {
                reset: h,
            ...
            createGroup: function (i, r, s) {
                var o = {
                    tempCollection: [], renderers: {}, container: i, filters: [], getLayers: function () {
                        ...
                        if (t && (t.id = t.id || a.uid(), this.tempCollection.push(t)), this.container())for (var i = this.container(), n = this.tempCollection, s = 0; s < n.length; s++) {
                            t = n[s];
                            var o = t.container, l = t.id, d = t.topmost;
                            if (!o.parentNode)if (d) i.appendChild(o); else {
                        ...
                        return t && ("function" == typeof t && (t = {renderer: t}), void 0 === t.filter ? t.filter = n(s || []) : t.filter instanceof Array && (t.filter.push(s), t.filter = n(t.filter)), t.container || (t.container = document.createElement("div"))), this._add(t), t ? t.id : void 0
    ...
    var i = function (t) {
        function e(e, i, s) {
            ...
            return s && s.setAttribute(n.config().layer_attribute, !0), a[e] = {
                ...
                }, rendered: r[e], node: s, destructor: function () {
        ...
        var n = t.$services, r = {}, a = {};
        return {getRenderer: e, clearRenderers: i}
    };
    t.exports = i
}, function (t, e, i) {
    var n = i(3), r = i(12), a = i(5), s = function (t) {
        "use strict";
        function e(e, i, n) {
    ...
    var n = i(3), r = i(0), a = i(5), s = function (t) {
        "use strict";
        function e(e, i, n) {
    ...
    var n = i(3), r = i(1), a = i(0), s = i(5), o = function (t) {
        "use strict";
        function e(e, i, n) {
        ...
        return n(e, t), e.prototype.init = function () {
            ...
            var e = this._xMode ? "offsetWidth" : "offsetHeight",
                ...
                r = this._behind.$view[e], a = this._front.getSize().gravity, s = this._behind.getSize().gravity,
                o = (n - i) / n * a, l = (r + i) / r * s;
    ...
    var n = i(3), r = i(1), a = i(0), s = i(6), o = (i(2), i(5)), l = function (t) {
        "use strict";
        function e(e, i, n, r) {
        ...
        return n(e, t), e.prototype.init = function (t) {
            ...
            for (var t, e = 0, i = 0, n = this._isHorizontal(), r = this._getLinkedViews(), a = n ? "scrollWidth" : "scrollHeight", s = n ? "contentX" : "contentY", o = n ? "x" : "y", l = this._getScrollOffset(), d = 0; d < r.length; d++)if ((t = r[d]) && t.$content && t.$content.getSize) {
                var c, h = t.$content.getSize();
                if (c = h.hasOwnProperty(a) ? h[a] : h[s], l) h[s] > h[o] && h[s] > e && c > h[o] - l + 2 && (e = c + (n ? 0 : 2), i = h[o]); else {
                    var u = Math.max(h[s] - c, 0), _ = Math.max(h[o] - u, 0);
            ...
            if (this._isVertical()) {
                ...
                var r = i[n], a = r.$parent, s = a.$cells, o = s[s.length - 1];
            ...
            if (this._checkWheelTarget(e)) {
                ...
                if (!t.shiftKey || t.deltaX || t.wheelDeltaX || (r = 2 * a, a = 0), r && Math.abs(r) > Math.abs(a)) {
                    ...
                    var o = r / -40, l = this._oldLeft, d = l + 30 * o;
                    ...
                    var o = a / -40;
                    void 0 === a && (o = t.detail);
                    var c = this._oldTop, h = this.$scroll_ver.scrollTop + 30 * o;
        ...
        return {
            getSum: function (t, e, i) {
                ...
                for (var o = this.splitSize(n, t.length), l = i, d = [], c = t.length - 1; c >= 0; c--) {
                    var h = c == t.length - 1, u = this.initScaleConfig(t[c], r, a);
    ...
    var n = i(0), r = i(6), a = function (t, e) {
        function i(t, e, i, n) {
            if (e.static_background) {
                if (document.createElement("canvas").getContext) {
                    t.innerHTML = "";
                    var r = _(t), a = h(r, e, i), s = u(a, e, i, n), o = document.createDocumentFragment();
        ...
        function d(t, e, i) {
            ...
            var a = Math.floor(500 / t) || 1, s = Math.floor(500 / e) || 1, o = document.createElement("canvas");
            ...
            return function (t, e, i, a, s, o) {
                ...
                var f = 1 * o.bottomBorderWidth, p = r(o.bottomBorderColor);
                u = 0;
        ...
        function u(t, i, n, r) {
            var a, s, o = [], l = 0, d = n.width.filter(function (t) {
                return !!t
            }), c = 0, h = 1e5;
            if (e.isIE) {
        ...
        var g = {}, f = "gantt-static-bg-styles-" + t.uid();
        return {render: i}
    };
    t.exports = {
        create: function () {
    ...
    function n(t, e) {
        var i = function () {
            ...
            column_before_start: t.bind(function (t, i, n) {
                ...
                var s = this.locate(n, a.grid_resizer_column_attribute), o = e.getGridColumns()[s];
            ...
            }, t), column_drag_move: t.bind(function (t, i, n) {
                var a = e.$getConfig(), s = t.config, o = e.getGridColumns(), l = parseInt(s.drag_index, 10), d = o[l],
                    c = r.getNodePosition(e.$grid_scale), h = parseInt(s.marker.style.left, 10),
                    u = d.min_width ? d.min_width : a.min_grid_column_width, _ = e.$grid_data.offsetWidth, g = 0, f = 0;
                ...
                if (d.max_width && d.max_width < h && (h = d.max_width), !1 !== e.callEvent("onColumnResizeEnd", [l, d, h]) && d.width != h) {
                    if (d.width = h, a.keep_grid_width) o = a.grid_width; else for (var c = l, u = s.length; c < u; c++)o += s[c].width;
        ...
        return {
            init: function () {
                var i = t.$services.getService("dnd"), r = e.$getConfig(),
    ...
    var n = i(1), r = i(0), a = i(15), s = i(8), o = i(3), l = function (t) {
        function e(e, i, n, r) {
    ...
    var n = i(0), r = i(13), a = i(15), s = i(3), o = function (t) {
        function e(e, i, n, r) {
            var a = t.apply(this, arguments) || this;
    ...
    function i(t) {
        function e(e, n) {
            var r = n.$getConfig(), a = r.type_renderers, s = a[t.getTaskType(e.type)], o = i;
        ...
        function i(e, i) {
            if (!t._isAllowedUnscheduledTask(e)) {
                var n = i.getItemPosition(e), s = i.$getConfig(), d = i.$getTemplates(), u = i.getItemHeight(),
                    _ = t.getTaskType(e.type), g = Math.floor((t.config.row_height - u) / 2);
                _ == s.types.milestone && s.link_line_width > 1 && (g += 1), _ == s.types.milestone && (n.left -= Math.round(u / 2), n.width = u);
                var f = document.createElement("div"), p = Math.round(n.width);
        ...
        function l(e, i, n, r, a) {
            ...
            if (d.className = "gantt_task_progress_wrapper", d.appendChild(o), i.appendChild(d), t.config.drag_progress && !t.isReadonly(e)) {
                var c = document.createElement("div"), h = l;
        ...
        function c(e, i, n, r) {
            ...
            if (t.getTaskType(l.type) == a.types.milestone && s.push("gantt_milestone"), t.getTaskType(l.type) == a.types.project && s.push("gantt_project"), t.isSummaryTask(l) && s.push("gantt_dependent_task"), a.select_task && n == o.selected_task && s.push("gantt_selected"), n == o.drag_id && (s.push("gantt_drag_" + o.drag_mode), o.touch_drag && s.push("gantt_touch_" + o.drag_mode)), o.link_source_id == n && s.push("gantt_link_source"), o.link_target_id == n && s.push("gantt_link_target"), a.highlight_critical_path && t.isCriticalTask && t.isCriticalTask(l) && s.push("gantt_critical_task"), o.link_landing_area && o.link_target_id && o.link_source_id && o.link_target_id != o.link_source_id) {
                var d = o.link_source_id, c = o.link_from_start, h = o.link_to_start, u = t.isLinkAllowed(d, n, c, h),
                    _ = "";
    ...
    function i(t) {
        function e(e, i) {
            ...
            var u = t.getGlobalTaskIndex(e.id) % 2 != 0, _ = r.task_row_class(e.start_date, e.end_date, e),
    ...
    function i(t) {
        function e(e, n) {
            var s = n.$getConfig(), o = a.get_points(e, n), l = r.get_lines(o, n), d = document.createElement("div"),
                c = "gantt_task_link";
            ...
            var g = l[l.length - 1].direction, f = i(o[o.length - 1], g, n);
            return e.color && (f.style.borderColor = e.color), d.appendChild(f), t._waiAria.linkAttr(e, d), d
        }

        function i(t, e, i) {
            var n = i.$getConfig(), a = document.createElement("div"), s = t.y, o = t.x, l = n.link_arrow_size,
                d = n.row_height, c = "gantt_link_arrow gantt_link_arrow_" + e;
            switch (e) {
                case r.dirs.right:
                    s -= (l - d) / 2, o -= l;
                    break;
        ...
        var r = {
            ...
            get_wrapper_sizes: function (t, e) {
                var i, n = e.$getConfig(), r = n.link_wrapper_width,
            ...
            path: [], clear: function () {
                ...
                var n = this.get_endpoint(e, i), a = t.config, s = n.e_y - n.y, o = n.e_x - n.x, l = r.dirs;
                this.clear(), this.point({x: n.x, y: n.y});
                var d = 2 * a.link_arrow_size, c = this.get_line_type(e, i.$getConfig()), h = n.e_x > n.x;
                if (c.from_start && c.to_start) this.point_to(l.left, d), h ? (this.point_to(l.down, s), this.point_to(l.right, o)) : (this.point_to(l.right, o), this.point_to(l.down, s)), this.point_to(l.right, d); else if (!c.from_start && c.to_start)if (h = n.e_x > n.x + 2 * d, this.point_to(l.right, d), h) o -= d, this.point_to(l.down, s), this.point_to(l.right, o); else {
                    o -= 2 * d;
                    var u = s > 0 ? 1 : -1;
                    ...
                    if (c.from_start && !c.to_start)if (h = n.e_x > n.x - 2 * d, this.point_to(l.left, d), h) {
                        o += 2 * d;
                        var u = s > 0 ? 1 : -1;
                ...
                var r = i.$getConfig(), a = (r.links, this.get_line_type(e, r)), s = a.from_start, o = a.to_start,
                    l = t.getTask(e.source), d = t.getTask(e.target), c = n(l, i), h = n(d, i);
    ...
    function n(t) {
        function e(e, i) {
            var n = i.getGridColumns(), a = i.$getConfig(), s = i.$getTemplates(), o = i.$config.rowStore;
            a.rtl && (n = n.reverse());
            for (var l, d = [], c = 0; c < n.length; c++) {
                var h, u, _, g = c == n.length - 1, f = n[c];
                if ("add" == f.name) {
                ...
                var v = "gantt_cell" + (g ? " gantt_last_cell" : ""), m = [];
                if (f.tree) {
                ...
                onCreated: function (e) {
                    ...
                    this._mouseDelegates.delegate("click", "gantt_row", e.bind(function (i, n, r) {
                        ...
                        if (e.callEvent("onGridHeaderClick", [a, i])) {
                            ...
                            if (s.sort) {
                                for (var o, l = a, d = 0; d < s.columns.length; d++)if (s.columns[d].name == a) {
                                    o = s.columns[d];
                                    break
                                }
    ...
    function n(t, e) {
        ...
        if (e.$config.bind && t.getDatastore(e.$config.bind)) {
            ...
            t.defined(e.$getConfig().dnd_sensitivity) && (s.config.sensitivity = e.$getConfig().dnd_sensitivity), s.attachEvent("onBeforeDragStart", t.bind(function (r, a) {
                ...
                var l = o.getAttribute(e.$config.item_attribute), d = n(), c = d.getItem(l);
                ...
                var l = n(), d = l.getItem(s.config.id);
                ...
                var i = r.getNodePosition(e.$grid_data), a = n(), s = i.x, o = t.pos.y - 10, l = e.$getConfig();
                o < i.y && (o = i.y);
                ...
                var i = r.getNodePosition(e.$grid_data), n = t.pageY - i.y + (e.$state.scrollTop || 0);
                return n < 0 && (n = 0), n
            }, t), s._getTaskByY = t.bind(function (t, i) {
                var r = e.$getConfig(), a = n();
                t = t || 0;
                ...
                var a = s.config, o = s._getGridPos(i), l = e.$getConfig(), d = n();
                a.marker.style.left = o.x + 10 + "px", a.marker.style.top = o.y + "px";
                var c = d.getItem(s.config.id), h = s._getTargetY(i), u = s._getTaskByY(h, d.getIndexById(c.id));
                if (d.exists(u) || (u = s.lastTaskOfLevel(l.order_branch_free ? c.$level : 0)) == s.config.id && (u = null), d.exists(u)) {
                    ...
                    if (d.getIndexById(_.id) * l.row_height + l.row_height / 2 < h) {
                        var g = d.getIndexById(_.id), f = d.getNext(_.id), p = d.getItem(f);
                        if (p) {
                ...
                var t = n(), e = t.getItem(s.config.id);
    ...
    var n = i(0), r = i(60), a = i(61), s = i(1), o = function () {
        return function (t) {
            var e = t.$services;
            return {
                onCreated: function (e) {
                    ...
                    this._mouseDelegates.delegate("click", "gantt_task_link", t.bind(function (t, e) {
                        ...
                        var i = this.locate(t), r = this.getTask(i), a = null;
    ...
    function n(t, e) {
        ...
        return {
            ...
            _resize_progress: function (e, i, n) {
                var r = this._drag_task_coords(e, n), a = t.$getConfig(),
                    s = a.rtl ? r.start - n.pos.x : n.pos.x - r.start, o = Math.max(0, s);
            ...
            on_mouse_move: function (t) {
                if (this.drag.start_drag) {
                    var i = a.getRelativeEventPosition(t, e.$task_data), n = this.drag.start_drag.start_x,
            ...
            _update_on_move: function (i) {
                ...
                if (n.mode) {
                    ...
                    var d = o.x - n.start_x, c = e.getTask(n.id);
            ...
            on_mouse_down: function (i, n) {
                if (2 != i.button || void 0 === i.button) {
                    ...
                    if (e.isTaskExists(s) && (o = e.getTask(s)), !e.isReadonly(o) && !this.drag.mode) {
                        ...
                        } else this.clear_drag_state(); else if (e.checkEvent("onMouseDown") && e.callEvent("onMouseDown", [l.split(" ")[0]]) && n.parentNode)return this.on_mouse_down(i, n.parentNode)
                    }
                }
            },
            _fix_dnd_scale_time: function (i, n) {
                ...
                var a = t.$getConfig(), s = e.getScale().unit, o = e.getScale().step;
                a.round_dnd_dates || (s = "minute", o = a.time_step), n.mode == a.drag_mode.resize ? n.left ? (i.start_date = e.roundDate({
                    date: i.start_date,
                    unit: s,
                    step: o
                }), r(i)) : (i.end_date = e.roundDate({date: i.end_date, unit: s, step: o}), function (i) {
                    if (e.config.correct_work_time) {
                        var n = t.$getConfig();
            ...
            _fix_working_times: function (i, n) {
                var r = t.$getConfig(), n = n || {mode: r.drag_mode.move};
            ...
            _get_drag_mode: function (e, i) {
                var n = t.$getConfig(), r = n.drag_mode, a = (e || "").split(" "), s = a[0],
    ...
    var n = i(1), r = function (t, e) {
        ...
        function o(t, n, r) {
            var a = n(t), s = {x: a.left, y: a.top, width: a.width, height: a.height};
        ...
        function h(t, i, n, r) {
            var s = g(), o = a(), l = ["gantt_link_direction"];
            ...
            if (d = Math.max(0, d - 3)) {
                s.className = l.join(" ");
                var c = (r - i) / (n - t), h = Math.atan(c);
                2 == _(t, n, i, r) ? h += Math.PI : 3 == _(t, n, i, r) && (h -= Math.PI);
                var f = Math.sin(h), p = Math.cos(h), v = Math.round(i), m = Math.round(t),
                ...
                if (-1 != window.navigator.userAgent.indexOf("MSIE 8.0")) {
                    ...
                    var y = Math.abs(Math.round(t - n)), b = Math.abs(Math.round(r - i));
                    switch (_(t, n, i, r)) {
                        case 1:
                            v -= b;
                            break;
        ...
        var p, v, m, k, y, b = e.$services, $ = b.getService("state"), w = b.getService("dnd");
        ...
        x.attachEvent("onBeforeDragStart", e.bind(function (i, r) {
            ...
            var a = x.config, o = x.getPosition(r);
            d(a.marker, o);
            var c = !!n.locateClassName(r, "gantt_link_control"), u = v, _ = p, g = m, f = e.locate(r), k = !0;
            if (c && (k = !n.locateClassName(r, "task_end_date"), c = !!f), v = f, p = c, m = k, c) {
                var y = e.getTask(f), b = t.$getConfig(), $ = n.locateClassName(r, "gantt_link_control"), w = 0;
                    ...
                    if (i && i.$parent && i.$parent.$parent && i.$parent.$parent._xLayout) {
                        ...
                        if (r && "resizer" == r.$name || (r = n.getPrevSibling(i.$parent.$id), a = !1), r && "resizer" == r.$name) {
                            ...
                            r.attachEvent("onResizeStart", function (e, i) {
                                ...
                                var s = a ? e : i, o = a ? n : r, l = t.$ui.getView("grid"), d = l ? l.$parent : null;
    ...
    function n(t) {
        ...
        function n(e) {
            ...
            if (t.isTaskExists(e.target))for (var r = t.getTask(e.target), n = 0; n < r.$target.length; n++)if (r.$target[n] == e.id) {
                r.$target.splice(n, 1);
                break
            }
        }
    ...
    var a = i(0), s = i(66), o = i(67), l = i(16), d = i(18), c = i(68), h = i(69), u = function () {
        return {
    ...
    var i = function (t, e) {
        ...
        var r = e.getDatastore(t), a = {
            renderItem: function (t, e) {
                var i = e.getLayers(), n = r.getItem(t);
    ...
    function n(t) {
        ...
        function n(t, e) {
            e.setGanttMode = function (t) {
                ...
                var s = {};
                for (var o in r)if ("$" != o.substr(0, 1)) {
                    var l = r[o];
        ...
        setTransactionMode: function (t, e) {
            ...
            if (t) {
                ...
                if ("GET" == this._tMode) r.query({
                    ...
                    var c = this.getState(e), h = a.replace(/(\&|\?)editing\=true/, ""), l = "", u = "post";
            ...
            for (var c = 0; c < d.length; c++) {
                var h = d[c], a = h.getAttribute("type"), s = h.getAttribute("sid"), o = h.getAttribute("tid");
    ...
    t.exports = function (t) {
        for (var e = [i(74), i(75), i(76), i(77), i(78), i(79)], n = 0; n < e.length; n++)e[n] && e[n](t)
    }
}, function (t, e, i) {
    var n = i(1);
    t.exports = function (t) {
        ...
        function a(i) {
            ...
            m = {x: i.clientX, y: i.clientY}, !_ && n && r(!0)
        }

        function s() {
            if (!e())return r(!1), !1;
            var i = n.getNodePosition(t.$task), a = m.x - i.x, s = m.y - i.y, d = g ? 0 : o(a, i.width, v.x - i.x),
                h = o(s, i.height, v.y - i.y), u = t.getScrollState(), _ = u.y, f = u.inner_height, p = u.height,
                k = u.x, y = u.inner_width, b = u.width;
        ...
        var d = 50, c = 30, h = 10, u = 50, _ = null, g = !1, f = null, p = {}, v = {started: !1}, m = {};
        t.attachEvent("onGanttReady", function () {
    ...
    function i(t) {
        ...
        function a(i, n, r) {
            for (var a = e(i, n), s = r.unit, o = {}, l = 0; l < a.length; l++)for (var d = a[l], c = t.date[s + "_start"](new Date(d.start_date)); c < d.end_date;) {
                var h = c;
        ...
        function s(t, e) {
            for (var i = e.$getConfig(), n = e.$getTemplates(), a = r(i.resource_property, t.id, e.getScale()), s = [], o = 0; o < a.length; o++) {
                var l = a[o], d = n.resource_cell_class(l.start_date, l.end_date, t, l.tasks),
    ...
    t.exports = function (t) {
        ...
        var n = i(18), r = n.prototype.hasChild;
        t.$data.tasksStore.hasChild = function (e) {
            ...
            if (t.config.branch_loading && t._load_url && e(i)) {
                ...
                var r = n.indexOf("?") >= 0 ? "&" : "?", a = t.getScrollState().y || 0;
    ...
    t.exports = function (t) {
        ...
        var r = new RegExp("<(?:.|\n)*?>", "gm"), a = new RegExp(" +", "gm"), s = new RegExp("'", "gm");
        t._waiAria = {
            getAttributeString: function (t) {
                ...
                var r = t.config.links, a = i.type == r.finish_to_start || i.type == r.start_to_start,
    ...
    t.exports = function (t) {
        t.load = function (e, i, n) {
            ...
            _xmlNodeToJSON: function (t, e) {
                ...
                for (var i = {}, n = t.ajax.xpath("//coll_options", e), r = 0; r < n.length; r++)for (var a = n[r].getAttribute("for"), s = i[a] = [], o = t.ajax.xpath(".//item", n[r]), l = 0; l < o.length; l++) {
    ...
    var n = i(87), r = i(90), a = i(92), s = i(0);
    t.exports = function (t) {
    ...
    n.prototype = {
        ...
        createCalendar: function (t) {
            ...
            r.mixin(e, i);
            var n = r.uid(), o = {id: n + "", worktime: this._convertWorktimeSettings(e)},
                l = new s(this.$gantt, a(this.$gantt));
            return r.mixin(l, o), l._tryChangeCalendarSettings(function () {
            }) ? l : null
        },
    ...
    n.prototype = {
        units: ["year", "month", "week", "day", "hour", "minute"], _getUnitOrder: function (t) {
            ...
            var l = this.$gantt.date.day_start(new Date(a)), d = a, c = this._getWorkUnitsBetweenGeneric(s, o, i, n),
                h = this._getWorkUnitsBetweenGeneric(l, d, i, n), u = this._getWorkHoursForRange(o, l);
            return u = u / n + c + h
            ...
            var e = t.unit, i = this.$gantt.date[e + "_start"](t.date), n = new Date(i), r = new Date(i), a = !0, s = 0,
                o = "any" == t.dir || !t.dir, l = 1;
    ...
    t.exports = function (t) {
        t.isUnscheduledTask = function (t) {
            ...
            n.isDate(e) && (e = {date: e, unit: t.getScale().unit, step: t.getScale().step});
            var i, r, a, s = e.date, o = e.step, l = e.unit, d = t.getScale();
            if (l == d.unit && o == d.step && +s >= +t._min_date && +s <= +t._max_date) a = Math.floor(t.columnIndexByDate(s)), t.getScale().trace_x[a] || (a -= 1, d.rtl && (a = 0)), r = new Date(t.getScale().trace_x[a]), i = t.date.add(r, o, l); else {
    ...
    t.exports = function (t) {
        ...
        t._lightbox_methods = {}, t._lightbox_template = "<div class='gantt_cal_ltitle'><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><span class='gantt_title'></span></div><div class='gantt_cal_larea'></div>", t.$services.getService("state").registerProvider("lightbox", function () {
            ...
            if (this.config.round_dnd_dates) {
                var i = t.getScale(), n = a.getSecondsInUnit(i.unit) * i.step / 60;
            ...
            if (void 0 === e && (e = this.getLightboxType()), !this._lightbox || this.getLightboxType() != this.getTaskType(e)) {
                ...
                for (var o = 0; o < d.length; o++) {
                    ...
                    if (u.id && document.getElementById(u.id)) {
                        var _ = document.getElementById(u.id), g = _.querySelector("label"), f = _.nextSibling;
                        if (f) {
            ...
            t.lightbox_events = {}, t.lightbox_events.gantt_save_btn = function (e) {
                ...
                if (i.getAttribute("dhx_button")) t.callEvent("onLightboxButton", [i.className, i, e]); else {
                    ...
                    if (-1 != o.indexOf("gantt_custom_button"))if (-1 != o.indexOf("gantt_custom_button_"))for (n = i.parentNode.getAttribute("index"), s = i; s && -1 == r.getClassName(s).indexOf("gantt_cal_lsection");)s = s.parentNode; else n = i.getAttribute("index"), s = i.parentNode, i = i.firstChild;
                ...
                e = e || window.event;
                var i = e.target ? e.target : e.srcElement, n = r.getClassName(i);
                ...
                var i = e || window.event, n = e.target || e.srcElement,
            ...
            for (var s = this._get_typed_lightbox_config(this.getLightboxType()), o = 0; o < s.length; o++) {
                ...
                if (this.form_blocks[l.type]) {
                    var d = document.getElementById(l.id).nextSibling, c = this.form_blocks[l.type],
            ...
            getTimePicker: function (e, i) {
                ...
                var r = this.config, s = this.date.date_part(new Date(t._min_date.valueOf())), o = 1440, l = 0;
                ...
                render: function (t) {
                    ...
                    if (r._time_format_size, a.auto_end_date)for (var l = function () {
                    ...
                    var r = e.getElementsByTagName("select"), a = n._time_format_order, s = 0, o = 0;
                    if (t.defined(a[3])) {
                    ...
                    var h = t._resolve_default_mapping(n), u = {start_date: new Date(d), end_date: new Date(c)};
                ...
                render: function (t) {
                    ...
                    var i = this.locale.labels[this.config.duration_unit + "s"],
                        n = t.single_date ? ' style="display:none"' : "", r = t.readonly ? " disabled='disabled'" : "",
                    ...
                    var o = r, l = e.getElementsByTagName("select"), d = e.getElementsByTagName("input"), c = d[1],
                        h = [d[0], d[2]], u = e.getElementsByTagName("span")[0], _ = r._time_format_order;
    ...
    t.exports = function (t) {
        t.getTaskType = function (e) {
            ...
            render: function (e) {
                var i = t.config.types, n = t.locale.labels, r = [], a = e.filter || function () {
                        return !0
                    };
    ...
    t.exports = function (t) {
        ...
        t._cached_functions = {
            cache: {}, mode: !1, critical_path_mode: !1, wrap_methods: function (t, e) {
                ...
                var e = [], i = ["_isCriticalTask", "isCriticalLink", "_isProjectEnd", "_getProjectEnd", "_getSlack"];
    ...
    function n(t, e) {
        var n = e.skin;
        if (!n || t)for (var r = document.getElementsByTagName("link"), a = 0; a < r.length; a++) {
    ...
    t.exports = function (t) {
        ...
        t._touch_events = function (n, r, a) {
            ...
            function o(e) {
                ...
                if (n && t.isTaskVisible(e))for (var r = 0; r < i.length; r++)if ((n = i[r].rendered[e]) && n.getAttribute("task_id") && n.getAttribute("task_id") == e) {
                    var a = n.cloneNode(!0);
            ...
            i = [], i.push([t.$container, n[0], function (i) {
                ...
                if (!a(i) && c) {
                    ...
                    if (!t._prevent_touch_scroll) {
                        if (o && u) {
                            var g = u.pageX - o.pageX, f = u.pageY - o.pageY;
    ...
    t.exports = function (t) {
        ...
        t.assert = i(109)(t), t.init = function (e, i, r) {
            ...
            var i = this._getVerticalScrollbar(), n = this._getHorizontalScrollbar(), r = i.getScrollState(),
                a = n.getScrollState();
            1 * t == t && n.scroll(t), 1 * e == e && i.scroll(e);
            var s = i.getScrollState(), o = n.getScrollState();
            ...
            var e = {
                ...
                x_inner: 0,
                y_inner: 0
            }, i = t._getVerticalScrollbar(), n = t._getHorizontalScrollbar();
            if (n) {
    ...
    t.exports = function (t) {
        function e(e, i) {
            var n = t.env.isIE ? "" : "%c",
                ...
                a = window.console.warn || window.console.log, s = [r];
 ...
 *
 */
Gantt.plugin(function(t){!function(t){function e(n){if(i[n])return i[n].exports;var r=i[n]={i:n,l:!1,exports:{}};return t[n].call(r.exports,r,r.exports,e),r.l=!0,r.exports}var i={};e.m=t,e.c=i,e.d=function(t,i,n){e.o(t,i)||Object.defineProperty(t,i,{configurable:!1,enumerable:!0,get:n})},e.n=function(t){var i=t&&t.__esModule?function(){return t.default}:function(){return t};return e.d(i,"a",i),i},e.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)},e.p="",e(e.s=5)}([function(t,e){t.exports=function(t){t._get_linked_task=function(e,i){var n=null,r=i?e.target:e.source;t.isTaskExists(r)&&(n=t.getTask(r));var a=i?"target":"source";return t.assert(n,"Link "+a+" not found. Task id="+r+", link id="+e.id),n},t._get_link_target=function(e){return t._get_linked_task(e,!0)},t._get_link_source=function(e){return t._get_linked_task(e,!1)},t._formatLink=function(e){var i=[],n=this._get_link_target(e),r=this._get_link_source(e);if(!r||!n)return i;if(t.isChildOf(r.id,n.id)&&t.isSummaryTask(n)||t.isChildOf(n.id,r.id)&&t.isSummaryTask(r))return i;for(var a=this._getImplicitLinks(e,r,function(t){return 0}),s=t.config.auto_scheduling_move_projects,c=this.isSummaryTask(n)?this.getSubtaskDates(n.id):{start_date:n.start_date,end_date:n.end_date},o=this._getImplicitLinks(e,n,function(e){return s?e.$target.length||t.getState().drag_id==e.id?0:t.calculateDuration({start_date:c.start_date,end_date:e.start_date,task:r}):0}),u=0;u<a.length;u++)for(var d=a[u],h=0;h<o.length;h++){var _=o[h],l=1*d.lag+1*_.lag,g={id:e.id,type:e.type,source:d.task,target:_.task,lag:(1*e.lag||0)+l};i.push(t._convertToFinishToStartLink(_.task,g,r,n))}return i},t._isAutoSchedulable=function(t){return!1!==t.auto_scheduling},t._getImplicitLinks=function(t,e,i){var n=[];return this.isSummaryTask(e)?this.eachTask(function(t){this.isSummaryTask(t)||n.push({task:t.id,lag:i(t)})},e.id):n.push({task:e.id,lag:0}),n},t._getDirectDependencies=function(t,e){for(var i=[],n=[],r=e?t.$source:t.$target,a=0;a<r.length;a++){var s=this.getLink(r[a]);if(this.isTaskExists(s.source)&&this.isTaskExists(s.target)){var c=this.getTask(s.target);this._isAutoSchedulable(c)&&i.push(this.getLink(r[a]))}}for(var a=0;a<i.length;a++)n=n.concat(this._formatLink(i[a]));return n},t._getInheritedDependencies=function(t,e){var i=[],n=!1,r=[];if(this.isTaskExists(t.id)){this.eachParent(function(t){n||this.isSummaryTask(t)&&(this._isAutoSchedulable(t)?r.push.apply(r,this._getDirectDependencies(t,e)):n=!0)},t.id,this);for(var a=0;a<r.length;a++){(e?r[a].source:r[a].target)==t.id&&i.push(r[a])}}return i},t._getDirectSuccessors=function(t){return this._getDirectDependencies(t,!0)},t._getInheritedSuccessors=function(t){return this._getInheritedDependencies(t,!0)},t._getDirectPredecessors=function(t){return this._getDirectDependencies(t,!1)},t._getInheritedPredecessors=function(t){return this._getInheritedDependencies(t,!1)},t._getSuccessors=function(t){return this._getDirectSuccessors(t).concat(this._getInheritedSuccessors(t))},t._getPredecessors=function(t){return this._getDirectPredecessors(t).concat(this._getInheritedPredecessors(t))},t._convertToFinishToStartLink=function(e,i,n,r){var a={target:e,link:t.config.links.finish_to_start,id:i.id,lag:i.lag||0,source:i.source,preferredStart:null},s=0;switch(i.type){case t.config.links.start_to_start:s=-n.duration;break;case t.config.links.finish_to_finish:s=-r.duration;break;case t.config.links.start_to_finish:s=-n.duration-r.duration;break;default:s=0}return a.lag+=s,a}}},,,,,function(t,e,i){t.exports=i(6)},function(e,i,n){n(0)(t),t.config.highlight_critical_path=!1,t._criticalPathHandler=function(){t.config.highlight_critical_path&&t.render()},t.attachEvent("onAfterLinkAdd",t._criticalPathHandler),t.attachEvent("onAfterLinkUpdate",t._criticalPathHandler),t.attachEvent("onAfterLinkDelete",t._criticalPathHandler),t.attachEvent("onAfterTaskAdd",t._criticalPathHandler),t.attachEvent("onAfterTaskUpdate",t._criticalPathHandler),t.attachEvent("onAfterTaskDelete",t._criticalPathHandler),t._isCriticalTask=function(t,e){if(t&&t.id){var i=e||{};if(this._isProjectEnd(t))return!0;i[t.id]=!0;for(var n=this._getDependencies(t),r=0;r<n.length;r++){var a=this.getTask(n[r].target);if(this._getSlack(t,a,n[r])<=0&&!i[a.id]&&this._isCriticalTask(a,i))return!0}return!1}},t.isCriticalTask=function(e){return t.assert(!(!e||void 0===e.id),"Invalid argument for gantt.isCriticalTask"),this._isCriticalTask(e,{})},t.isCriticalLink=function(e){return this.isCriticalTask(t.getTask(e.source))},t.getSlack=function(t,e){for(var i=[],n={},r=0;r<t.$source.length;r++)n[t.$source[r]]=!0;for(var r=0;r<e.$target.length;r++)n[e.$target[r]]&&i.push(e.$target[r]);for(var a=[],r=0;r<i.length;r++){var s=this.getLink(i[r]);a.push(this._getSlack(t,e,this._convertToFinishToStartLink(s.id,s,t,e)))}return Math.min.apply(Math,a)},t._getSlack=function(t,e,i){var n=this.config.types,r=null;r=this.getTaskType(t.type)==n.milestone?t.start_date:t.end_date;var a=e.start_date,s=0;s=+r>+a?-this.calculateDuration({start_date:a,end_date:r,task:t}):this.calculateDuration({start_date:r,end_date:a,task:t});var c=i.lag;return c&&1*c==c&&(s-=c),s},t._getProjectEnd=function(){var e=t.getTaskByTime();return e=e.sort(function(t,e){return+t.end_date>+e.end_date?1:-1}),e.length?e[e.length-1].end_date:null},t._isProjectEnd=function(t){return!this._hasDuration({start_date:t.end_date,end_date:this._getProjectEnd(),task:t})},t._getSummaryPredecessors=function(e){var i=[];return this.eachParent(function(e){this.isSummaryTask(e)&&(i=i.concat(t._getDependencies(e)))},e),i},t._getDependencies=function(t){return this._getSuccessors(t).concat(this._getSummaryPredecessors(t))}}])});
...
gantt.config.undo_steps=10,gantt.config.undo=!0,gantt.config.redo=!0,gantt.undo=function(){this._undo.undo()},gantt.getUndoStack=function(){return this._undo._undoStack},gantt.getRedoStack=function(){return this._undo._redoStack},gantt.redo=function(){this._undo.redo()},gantt.config.undo_types={link:"link",task:"task"},gantt.config.undo_actions={update:"update",remove:"remove",add:"add"},gantt._undo={_undoStack:[],_redoStack:[],maxSteps:10,undo_enabled:!0,redo_enabled:!0,_push:function(t,e){if(e.commands.length){
    ...
    gantt.callEvent("onAfterRedo",[])}},_applyAction:function(t){var e=null,n=this.command.entity,a=this.command.type,i={};i[n.task]={add:"addTask",update:"updateTask",remove:"deleteTask",isExists:"isTaskExists"},i[n.link]={add:"addLink",update:"updateLink",remove:"deleteLink",isExists:"isLinkExists"},gantt.batchUpdate(function(){for(var n=0;n<t.commands.length;n++){e=t.commands[n];var s=i[e.entity][e.type],r=i[e.entity].isExists;e.type==a.add?gantt[s](e.oldValue,e.oldValue.parent,e.oldValue.$index):e.type==a.remove?gantt[r](e.value.id)&&gantt[s](e.value.id):e.type==a.update&&gantt[s](e.value.id,e.value);
}})},logAction:function(t){this._push(this._undoStack,t),this._redoStack=[]},action:{create:function(t){return{commands:t?t.slice():[]}},invert:function(t){for(var e=gantt.copy(t),n=gantt._undo.command,a=0;a<t.commands.length;a++){var i=e.commands[a]=n.invert(e.commands[a]);if(i.type==n.type.update){var s=i.value;i.value=i.oldValue,i.oldValue=s}}return e}},command:{create:function(t,e,n,a){return{entity:a,type:n,value:gantt.copy(t),oldValue:gantt.copy(e||t)}},invert:function(t){var e=gantt.copy(t);
